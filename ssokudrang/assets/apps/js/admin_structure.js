$(document).ready(function () {
    var dataTable = $('#table_data').DataTable({
        ...
        "pageLength": 50,
        "ajax": {
            url: site_url + '/admin_structure/fetch_admin_structure',
            data: {
...
crud.ajax = {
    del_data: function (id, cb) {
        var url = '/admin_structure/del_admin_structure',
            params = {
                id: id
            }
        ...
        var url = '/admin_structure/save_admin_structure',
            params = {
                items: items
            }
        ...
        var url = '/admin_structure/get_admin_structure',
            params = {
                id: id
            }
...
$('#frm_structure').submit(function (e) {
    e.preventDefault();
    var action;
    var items = {};
