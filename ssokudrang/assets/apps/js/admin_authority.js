$(document).ready(function () {
    var dataTable = $('#table_data').DataTable({
        ...
        "pageLength": 50,
        "ajax": {
            url: site_url + '/admin_authority/fetch_admin_authority',
            data: {
...
crud.ajax = {
    del_data: function (id, cb) {
        var url = '/admin_authority/del_admin_authority',
            params = {
                id: id
            }
        ...
        var url = '/admin_authority/save_admin_authority',
            params = {
                items: items
            }
        ...
        var url = '/admin_authority/get_admin_authority',
            params = {
                id: id
            }
...
$('#frm_authority').submit(function (e) {
    e.preventDefault();
    var action;
    var items = {};
