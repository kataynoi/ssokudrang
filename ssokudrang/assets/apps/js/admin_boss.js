$(document).ready(function () {
    var dataTable = $('#table_data').DataTable({
        ...
        "pageLength": 50,
        "ajax": {
            url: site_url + '/admin_boss/fetch_admin_boss',
            data: {
...
crud.ajax = {
    del_data: function (id, cb) {
        var url = '/admin_boss/del_admin_boss',
            params = {
                id: id
            }
        ...
        var url = '/admin_boss/save_admin_boss',
            params = {
                items: items
            }
        ...
        var url = '/admin_boss/get_admin_boss',
            params = {
                id: id
            }
