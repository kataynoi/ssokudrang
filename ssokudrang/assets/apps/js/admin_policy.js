$(document).ready(function () {
    var dataTable = $('#table_data').DataTable({
        ...
        "pageLength": 50,
        "ajax": {
            url: site_url + '/admin_policy/fetch_admin_policy',
            data: {
...
crud.ajax = {
    del_data: function (id, cb) {
        var url = '/admin_policy/del_admin_policy',
            params = {
                id: id
            }
        ...
        var url = '/admin_policy/save_admin_policy',
            params = {
                items: items
            }
        ...
        var url = '/admin_policy/get_admin_policy',
            params = {
                id: id
            }
