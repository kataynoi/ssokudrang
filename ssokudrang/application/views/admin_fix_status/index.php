...
<div class="row">
    <div class="panel panel-info ">
        <div class="panel-heading w3-theme">
            <i class="fa fa-user fa-2x "></i> สถานะการซ่อม
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <input type="hidden" class="form-control" id="row_id" placeholder="ROWID" value=""><div class="form-group">
                    ...
                    <label for="name">สถานะการซ่อม</label>
                    <input type="text" class="form-control" id="name" placeholder="สถานะการซ่อม" value=""></div>
      </div>
...
<script src="<?php echo base_url() ?>assets/apps/js/admin_fix_status.js" charset="utf-8"></script>
