...
<div class="row">
    <div class="panel panel-info ">
        <div class="panel-heading w3-theme">
            <i class="fa fa-user fa-2x "></i> ประเถทพนักงาน
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h4 class="modal-title">เพิ่มประเถทพนักงาน</h4>
      ...
      <div class="modal-body">
        ...
        <input type="hidden" class="form-control" id="row_id" placeholder="ROWID" value=""><div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name" placeholder="" value=""></div>
      </div>
...
<script src="<?php echo base_url() ?>assets/apps/js/admin_employee_type.js" charset="utf-8"></script>
