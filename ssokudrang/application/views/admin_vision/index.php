...
<div class="row">
    <div class="panel panel-info ">
        <div class="panel-heading w3-theme">
            <i class="fa fa-user fa-2x "></i> วิสัยทัศน์ พันธกิจ ค่านิยม
            </span>
...
<div class="modal fade" id="frmModal">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="modal-title">วิสัยทัศน์ พันธกิจ ค่านิยม</h4>
    ...
    <script src="<?php echo base_url() ?>assets/apps/js/admin_vision.js" charset="utf-8"></script>
