...
<div class="row">
    <div class="panel panel-info ">
        <div class="panel-heading w3-theme">
            <i class="fa fa-user fa-2x "></i> Link ภายนอก
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="modal-title">เพิ่มLink ภายนอก</h4>
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="name">ชื่อLink</label>
                    <input type="text" class="form-control" id="name" placeholder="ชื่อLink" value=""></div>
                <div class="form-group">
                    <label for="link">ที่อยู่Link</label>
                    <input type="text" class="form-control" id="link" placeholder="ที่อยู่Link" value=""></div>
            </div>
...
<script src="<?php echo base_url() ?>assets/apps/js/admin_link.js" charset="utf-8"></script>
