...
<div class="row">
    <div class="panel panel-info ">
        <div class="panel-heading w3-theme">
            <i class="fa fa-user fa-2x "></i> ประเภทปริ้นเตอร์
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h4 class="modal-title">เพิ่มประเภทปริ้นเตอร์</h4>
      ...
      <div class="modal-body">
        ...
        <input type="hidden" class="form-control" id="row_id" placeholder="ROWID" value=""><div class="form-group">
                    ...
                    <label for="name">Printer type</label>
                    <input type="text" class="form-control" id="name" placeholder="Printer type" value=""></div>
      </div>
...
<script src="<?php echo base_url() ?>assets/apps/js/admin_printertype.js" charset="utf-8"></script>
